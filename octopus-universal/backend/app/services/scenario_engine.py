...
def run_prediction(
    ...
    if clean_mode:
        # UNA sola proiezione: la Trasformata di Fourier pura sul numero di
        # componenti scelto. Come il software originale Pythagoras, l'output
        # e' un unico scenario, non varianti multiple.
        clean_component_variants = [params.n_components]
