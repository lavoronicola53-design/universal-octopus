...
export default function HomePage() {
  ...
  const reloadBars = useCallback(async () => {
    ...
    try {
      ...
      // Numero di candele storiche da caricare: molte di più sui timeframe
      // brevi (dove Binance ha storico profondo) per poter vedere piu'
      // indietro nel tempo e selezionare frattali piu' ampi.
      const barsToLoad = { "1m": 5000, "5m": 5000, "15m": 4000, "30m": 3000, "1h": 3000, "4h": 2000, "1d": 1500, "1w": 800 }[timeframe] ?? 1000;
      const start = now - secondsPerBar * barsToLoad;
